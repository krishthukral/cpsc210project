...
public class Reader {
    ...
    public static List<TodoList> readAccounts(File file) throws IOException {
    ...
    private static List<TodoList> parseContent(List<String> fileContent) {
        List<TodoList> accounts = new ArrayList<>();
    ...
    private static TodoList parseAccount(List<String> components) {
        ...
        return new TodoList(nextId, id, name, balance);
    }
}
